<%-- 
    Document   : panelJugadores
    Created on : 13-07-2020, 18:26:21
    ...
    <body>
        ...
        <nav id="ContainerPanel">
            ...
            <form id="detalles">
                ...
                Nombre: <input type="text" name="equipo" value="Nombre equipo" />
                Procedencia: <input type="text" name="procedencia" value="proce" />
                Estadio: <select name="Estadio">
                        <option>Coche</option>
                        <option>Avión</option>
                        <option>Tren</option>
                </select>
                Division: <input type="text" name="division" value="primera" />
        ...
        <script>
            function jugador(num){
                window.location.href = "panelJugador.jsp";
            }
        </script>
    </body>
</html>
